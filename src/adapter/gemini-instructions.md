<!-- Gemini/Antigravity-specific manas instructions. Appended to the shared
     manas instructions when `manas warm gemini` boots a session. Edit the
     seeded copy at ~/.manas/gemini-instructions.md to change this without a
     rebuild. -->
...
- Subject: imperative mood, no trailing period, ≤ ~70 chars, naming what the commit *does* ("Add --add-dir injection for AGENTS.md", not "fixed gemini"). Not "fixed", "changes", or "stuff".
